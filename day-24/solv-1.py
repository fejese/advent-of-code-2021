...
def get_max_valid(
    ...
    for input in range(9, 0, -1):
        ...
        if length == 1:
            ...
            sub_max_valid: Optional[int] = get_max_valid(
            ...
            if sub_max_valid is not None:
                max_valid: int = 10 ** (length - 1) * input + sub_max_valid
                # print(f"VALID: {max_valid}")
                CACHE[cache_key] = max_valid
                return max_valid
...
print(get_max_valid(instructions, 14))
